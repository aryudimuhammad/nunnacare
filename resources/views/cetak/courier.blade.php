...
<head>
    ...
    <title>Cetak Data Courier</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="headtext">
            <h1 style="margin:0px;">Data Courier</h1>
    ...
    <div class="container" style="margin-top:10px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Courier</h3>
        <table class='table table-bordered nowrap'>
            <thead>
                <tr>
                    <th scope="col" class="text-center">No</th>
                    <th scope="col" class="text-center">Nama Jasa Pengiriman</th>
