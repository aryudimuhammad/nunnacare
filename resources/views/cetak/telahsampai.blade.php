...
<head>
    ...
    <title>Cetak Data Pesanan Telah Sampai</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="headtext">
            <h1 style="margin:0px;">Data Pesanan Telah Sampai</h1>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Pesanan Telah Sampai</h3>
