...
<head>
    ...
    <title>Cetak Data Keranjang Belanja</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="headtext">
            <h1 style="margin:0px;">Data Keranjang Belanja</h1>
    ...
    <div class="container" style="margin-top:10px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Keranjang Belanja {{$data->name}}</h3>
