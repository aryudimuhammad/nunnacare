...
<head>
    ...
    <title>Cetak Data Barang Paling Laris</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="headtext">
            <h1 style="margin:0px;">Data Barang Paling Laris</h1>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Barang Paling Laris</h3>
